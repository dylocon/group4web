...
<html lang="en">
  ...
  <?php
  $dbUser = new SQLite3('/xampp/Data/StudentModule.db');
      ...
      <link rel="stylesheet" href="/groupfour-main/buttonstyle.css" />
          ...
          <?php if ($qID != null){ ?>
            ...
            <div>
                ...
                <input style="padding: 20px", type="text" value="Question ..."class="inputFields reviewInput" id="username" name=<?php echo "question6"?> readonly>
                <span> 
              </div>
              <div>
                <label for="floatingInput"class="loginFont reviewLabel"><?php echo "Question 7"?></label>
                <input style="padding: 20px", type="text" value="Question ..."class="inputFields reviewInput" id="username" name=<?php echo "question7"?> readonly>
                <span> 
              </div>
              <div>
                <label for="floatingInput"class="loginFont reviewLabel"><?php echo "Question 8"?></label>
                <input style="padding: 20px", type="text" value="Question ..."class="inputFields reviewInput" id="username" name=<?php echo "question8"?> readonly>
                <span> 
              </div>
