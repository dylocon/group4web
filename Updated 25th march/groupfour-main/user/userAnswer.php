...
Question_7, Question_8, Question_9, Question_10, Question_11, Question_12, AppraiserID FROM ReviewsQ WHERE ReviewID = :reviewID ");
$stmtQ->bindParam(':reviewID', $_GET['revieID'], SQLITE3_TEXT);
