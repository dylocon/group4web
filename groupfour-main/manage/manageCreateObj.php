...
include_once('/xampp/htdocs/groupfour-main/manage/manageCreateObjectiveSQL.php');
...
if (isset($_POST['submit'])) {
  ...
  if ($_POST['milestone1']=="" && $_POST['milestone2']==""  && $_POST['milestone3']==""  && $_POST['milestone4']=="" ){
    ...
    $createUserSQL = manageCreateObjectiveSQL();
    header('Location: manageCreateObjConfirmation.php?createObj='.$createUserSQL); 
    exit();
  }
